...
(function () {
  ...
  function initGlobalShell() {
      ...
      header.innerHTML = `
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <button
              id="synvio-header-ai-assistant"
              type="button"
              class="hidden sm:inline-flex items-center gap-2 px-4 py-2 text-xs uppercase font-mono tracking-wider text-neutral-300 border border-white/20 rounded hover:text-white hover:border-accentCyan hover:shadow-[0_0_18px_rgba(0,240,255,0.12)] transition-all"
            >
              <span class="w-1.5 h-1.5 rounded-full bg-accentCyan shadow-[0_0_7px_#00f0ff]"></span>
    ...
    if (!document.getElementById('synvio-chat-sidebar')) {
      ...
      // =======================================================
      const headerAssistantButton =
        document.getElementById('synvio-header-ai-assistant');

      if (headerAssistantButton) {
        headerAssistantButton.addEventListener('click', openSidebar);
      }
